<%@page import="com.bit.util.EmpDto"%>
...
public void insertOne(EmpDto bean) throws SQLException{
	String sql = "insert into emp (empno, ename, sal, hiredate) values ("+ bean.getEmpno() + ", '"+ bean.getEname() + "' ," + bean.getSal() + ",now())";
...
<%
request.setCharacterEncoding("utf-8");	// servlet filter...
