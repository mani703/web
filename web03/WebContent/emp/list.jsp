...
<body>
	<table align="center" width="800">
		...
		<tr>
			...
			<td bgcolor="grey" width="100" align="center"><a href="./list.jsp"><font color="white">[사원정보]</font></a></td>
...
String password = map.get("MYSQL_PASSWORD") == null ? "user01" : map.get("MYSQL_PASSWORD");
