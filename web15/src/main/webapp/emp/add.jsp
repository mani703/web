		...
		<div id="content" class="row">
			<div class="col-md-12">
				<div class="page-header">
					<h1>
						EMP Insert Page <small>EMP 추가</small>
					</h1>
				</div>
				...
				<form method="post">
					...
					<button type="submit" class="btn btn-primary btn-block">입 력</button>
					<button type="reset" class="btn btn-default btn-block">취 소</button>
