		...
		<div id="content" class="row">
			<div class="col-md-12">
				<div class="page-header">
					<h1>
						EMP Detail Page <small>상세보기</small>
					</h1>
				</div>
				<%
				...
				<form method="post">
					...
					<a href="edit.html?idx=<%=bean.getEmpno() %>" role="button" class="btn btn-primary btn-block">수 정</a>
					<a href="delete.html?idx=<%=bean.getEmpno() %>" role="button" class="btn btn-danger btn-block">삭 제</a>
					<button type="button" class="btn btn-default btn-block">뒤 로</button>
				</form>
